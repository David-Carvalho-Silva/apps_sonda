...
def processar_viagens(data_atual, token_autorizacao):
    ...
    mensagens_validas = {
        ...
        "1,0 - VEÍCULO OPERANDO COM PORTA ABERTA"],
        "ACIDENTE" : ["OK - B.O ACIDENTE","1,00 - ACIDENTE / AGUARDANDO O ENVIO DO B.O/IMAGENS","0,50 - ACIDENTE / AGUARDANDO O ENVIO DO B.O/IMAGENS"],
        "ATRASO OPERADOR": [
        ...
        "FALHA DE PAGAMENTO QR CODE":["OKC - FALHA DE PAGAMENTO QR CODE NO PRIMEIRO DIA",
        "OK - FALHA DE PAGAMENTO QR CODE NO PRIMEIRO DIA", "0,30 - FALHA DE PAGAMENTO QR CODE"],
        ...
        "ITINERÁRIO DESLIGADO/DEFEITO" :["OK - ITINERÁRIO COM DEFEITO NO PRIMEIRO DIA","OKC - ITINERÁRIO COM DEFEITO NO PRIMEIRO DIA","0,20 - ITINERÁRIO COM DEFEITO",
        "1,0 - ITINERÁRIO COM DEFEITO E VEÍCULO SEM PLACA"],
        ...
        "PROBLEMA NO AR CONDICIONADO":["1,0 - VEÍCULO OPERANDO COM PORTA ABERTA"],
        "QUEIMA DE PARADA": [
